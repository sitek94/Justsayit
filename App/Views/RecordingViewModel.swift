...
//                Logger.error("Recording URL is missing", category: "RecordingViewModel")
...
//
//            Logger.debug("Transcribed recording, transcription: \(transcription)")
//
//            // guard let selectedPreset else {
//            //     Logger.error("No preset selected", category: "RecordingViewModel")
//            //     throw RecordingError.custom("No preset selected. Please create one in Settings.")
//            // }
//
//            Logger.debug("Processing recording")
//            state = .processing
//            processedText = await aiProcessingService.process(transcription, with: selectedPreset?.asSendable ?? DEFAULT_PRESET)
//
//            Logger.debug("Processed recording, processedText: \(processedText)")
//
//            state = .outputting
//
//            Logger.debug("Outputting result to clipboard")
//            if pasteResultText {
